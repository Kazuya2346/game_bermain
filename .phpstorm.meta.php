...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Applications/MAMP/htdocs/tpq-arabic/public/storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./Applications/MAMP/htdocs/tpq-arabic/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'web','api',);
        registerArgumentsSet('routes', 'home','register.santri','register.santri.store','register','login','password.request','password.email',
'password.reset','password.store','verification.notice','verification.verify','verification.send',
'password.confirm','password.update','logout','dashboard',
'profile.edit','profile.update','profile.destroy','admin.dashboard','admin.users.index',
'admin.users.create','admin.users.store','admin.users.show','admin.users.edit','admin.users.update',
'admin.users.destroy','admin.games.index','admin.games.create','admin.games.store','admin.games.show',
'admin.games.edit','admin.games.update','admin.games.destroy','admin.games.toggleStatus','admin.questions.index',
'admin.questions.create','admin.questions.store','admin.questions.show','admin.questions.edit','admin.questions.update',
'admin.questions.destroy','ustadz.dashboard','ustadz.games.index','ustadz.games.create','ustadz.games.store',
'ustadz.games.show','ustadz.games.edit','ustadz.games.update','ustadz.games.destroy','ustadz.games.toggleStatus',
'ustadz.games.questions.index','ustadz.games.questions.create','ustadz.games.questions.store','ustadz.games.questions.edit','ustadz.games.questions.update',
'ustadz.games.questions.destroy','ustadz.scores.index','ustadz.scores.game','ustadz.scores.detail','ustadz.scores.matrix',
'santri.dashboard','santri.games','santri.games.play','santri.games.submit','santri.games.result',
'santri.scores','santri.profile','santri.leaderboard','santri.profile.photo.update','santri.profile.photo.delete',
'storage.local',);
        registerArgumentsSet('views', 
'admin.games.create','admin.games.edit','admin.games.index','admin.games.show','admin.questions.create',
'admin.questions.edit','admin.questions.index','admin.questions.show','admin.users.create','admin.users.edit',
'admin.users.index','auth.confirm-password','auth.forgot-password','auth.login','auth.register',
'auth.register-santri','auth.reset-password','auth.verify-email','components.application-logo','components.auth-session-status',
...
'components.text-input','dashboard','layouts.admin','layouts.app','layouts.guest',
'layouts.navigation','layouts.santri','layouts.ustadz','profile.edit','profile.partials.delete-user-form',
'profile.partials.update-password-form','profile.partials.update-profile-information-form','santri.dashboard','santri.games.index','santri.games.play',
'santri.games.result','santri.leaderboard.index','santri.profile','santri.scores.index','ustadz.dashboard',
'ustadz.games.create','ustadz.games.edit','ustadz.games.index','ustadz.games.show','ustadz.questions.create',
'ustadz.questions.edit','ustadz.questions.index','ustadz.scores.detail','ustadz.scores.game','ustadz.scores.index',
'ustadz.scores.matrix','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
...
'DB_HOST','DB_PORT','DB_DATABASE','DB_DATABASE','DB_PASSWORD',
